...
$('#busqueda').on('click',function(){
    ...
    var type = $("input[type='radio']:checked");
     ...
     $(location).attr('href', "http://localhost/projectrsa/front_end/search/"+name[0].value+"/"+type[0].value);
});

$('.login').on('click',function(){

     $(location).attr('href', "http://localhost/projectrsa/login");
});

$(".listar").on('click', function () {

        var id = $(this).attr('id');
        $(location).attr('href', "http://localhost/projectrsa/front_end/view/"+id);
