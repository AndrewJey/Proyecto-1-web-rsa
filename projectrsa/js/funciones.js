...
//editamos datos del usuario
    var roles = "";
    $.get("http://localhost/projectrsa/user/get_roles", function(role){
    ...
    $(".editar").on('click', function () {
        ...
        var popup = "<div class='edit_modal '><form class='edit_popup' name='edit' id='edit' method='post' action='http://localhost/projectrsa/user/multi_user'>"+
        "<label>Cedula</label><br/><input type='text' name='cedula' class='cedula' value="+cedula+" id='cedula' /><br/>"+
        "<label>Nombre</label><br/><input type='text' name='nombre' class='nombre' value="+nombre+" id='nombre'/>"+
        "<input type='hidden' name='id' class='id' id='id' value="+id+"><br/>"+
        "<label>Role</label><br/><select name='role' class='role' id='role'>"+roles+"</select><br/><br/>"+
        "<label>User</label><br/><input type='text' name='user' class='user' value="+user+" id='user' /><br/>"+
        "<label>Contraseña</label><br/><input type='password' name='pass' class='pass' id='pass'/><br/>"+
        "</form><div class='respuesta'></div></div>"
                    ...
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            if(obj.respuesta == 'error')
                            {
                                ...
                                $(".respuesta").html(obj.nombre + '<br />' + obj.user + '<br />' + obj.cedula + '<br />' + obj.pass);
                                return false;
                                ...
                                setTimeout(function() {
                                    window.location.href = "http://localhost/projectrsa/user";
                                }, 1000);
        ...
        $("<div class='delete_modal'>¡Estás seguro que deseas eliminar al usuario " + nombre + "?</div>").dialog({
            ...
            buttons:{
                ...
                "Eliminar":function () {
                    $.ajax({
                        type:'POST',
                        url:'http://localhost/projectrsa/user/delete_user',
                        async: true,
                        data: { id : id },
                        complete:function () {
...
Cancelar:function () {
    ...
    $(".agregar").on('click', function () {
        ...
        var role = $("#role" + id).html();
        var cedula = $("#cedula" + id).html();
        var pass = $("#pass" + id).html();

        $("<div class='insert_modal'><form class='add_popup' name='insert' id='insert' method='post' action='http://localhost/projectrsa/user/multi_user'>"+
            "<label>Cedula</label><br/><input type='text' name='cedula' class='cedula' id='cedula' /><br/>"+
            "<label>Nombre</label><br/><input type='text' name='nombre' class='nombre' id='nombre' /><br/>"+
            "<label>Role</label><br/><select name='role' class='role' id='role'>"+roles+"</select><br/>"+
            "<label>User</label><br/><input type='text' name='user' class='user' id='user' /><br/>"+
            "<label>Contraseña</label><br/><input type='password' name='pass' class='pass' id='pass' /><br/>"+
                    ...
                    "Insertar":function () {
                        $.ajax({
                            ...
                            success:function (data) {
                                ...
                                if(obj.respuesta == 'error')
                                {
                                    $(".respuesta").html(obj.nombre + '<br />' + obj.user + '<br />' + obj.pass + '<br />' + obj.cedula);
                                    return false;
...
$(".listar").on('click', function () {
        ...
        "<label>Cedula</label><br/><input type='text' name='cedula' class='cedula' value="+cedula+" id='cedula' readonly/><br/>"+
        "<label>Nombre</label><br/><input type='text' name='nombre' class='nombre' value="+nombre+" id='nombre' readonly/><br/>"+
        "<label>User</label><br/><input type='text' name='user' class='user' value="+user+" id='user' readonly/><br/>"+
        "<label>Role</label><br/><input type='text' name='role' class='role' value="+role+" id='role' readonly/><br/>"+
        "</form></div>";
