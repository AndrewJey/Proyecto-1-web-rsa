$(document).ready(function () {
    ...
    $(".editar").on('click', function () {
        ...
        var popup = "<div class='edit_modal'><form class='edit_popup' name='edit' id='edit' method='post' action='http://localhost/projectrsa/career/multi_career'>"+
        "<label>C&oacute;digo</label><br/><input type='text' name='code' class='code' value="+code+" id='code' /><br/>"+
        "<input type='hidden' name='id' class='id' id='id' value="+id+">"+
        "<label>Nombre</label><br/><input type='text' name='name' class='name' value=\""+name+"\" id='name' /><br/>"+
                    ...
                    $.ajax({
                        ...
                        success:function (data) {
                            ...
                            if(obj.respuesta == 'error')
                            {
                                ...
                                $(".respuesta").html(obj.code + '<br />' + obj.name);
                                return false;
                                ...
                                $("<div class='edit_modal'>La carrera fué editada correctamente</div>").dialog({
                                ...
                                setTimeout(function() {
                                    window.location.href = "http://localhost/projectrsa/career";
                                }, 1000);
...
Cancelar:function () {
    ...
    $(".eliminar").on('click', function () {
        ...
        $("<div class='delete_modal'>¡Estás seguro que deseas eliminar la carrera " + name + "?</div>").dialog({

            resizable:false,
            title:'Eliminar la carrera ' + name + '.',
            height:200,
            width:450,
            modal:true,
            buttons:{
                ...
                "Eliminar":function () {
                    $.ajax({
                        type:'POST',
                        url:'http://localhost/projectrsa/career/delete_career',
                        async: true,
                        data: { id : id },
                        complete:function () {
                            $('.delete_modal').dialog("close");
                            $("<div class='delete_modal'>La carrera " + name + " fué eliminada correctamente</div>").dialog({
                                resizable:false,
                            ...
                            $("<div class='delete_modal'>Ha ocurrido un error!</div>").dialog({
                                resizable:false,
                                title:'Error eliminando la carrera!.',
                                height:200,
                                width:550,
                                modal:true
...
Cancelar:function () {
    ...
    //añadimos carreras nuevas
    $(".agregar").on('click', function () {


        $("<div class='insert_modal'><form class='add_popup' name='insert' id='insert' method='post' action='http://localhost/projectrsa/career/multi_career'>"+
            "<label>Código</label><br/><input type='text' name='code' class='code' id='code' /><br/>"+
                        ...
                        $.ajax({
                            ...
                            success:function (data) {
                                ...
                                if(obj.respuesta == 'error')
                                {
                                    ...
                                    $("<div class='insert_modal'>La carrera fué añadida correctamente</div>").dialog({
                                        resizable:false,
...
$(".listar").on('click', function () {
        ...
        "<label>C&oacute;digo</label><br/><input type='text' name='code' class='code' value="+code+" id='code' readonly/><br/>"+
        "<label>Nombre</label><br/><input type='text' name='name' class='name' value=\""+name+"\" id='name' readonly/><br/>"+
        "</form></div>";
